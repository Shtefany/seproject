...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/styleMV.css" />
		...
		<!-- Aquí se coloca el menú -->
            ...
            <div id="all-content">
                ...
                <form name="Rvalida">
                    ...
                    <div id="fol">
                       <input type="text" name="folio" size="4" maxlength="7" value="0000001" disabled/>
                    </div>
                    ...
                    <div id="cliente1"class="box">
                       <select name="cliente" disabled> <option>Cliente1</option><option value="C2">Cliente2</option></select>
                    </div> 
